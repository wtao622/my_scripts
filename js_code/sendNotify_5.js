...
//(环境变量名 DD_BOT_TOKEN)
let DD_BOT_TOKEN = '2aa3905105945014232258ee50f35604e0e8e7f5687092f6a3509a6c9a795f29';
//密钥，机器人安全设置页面，加签一栏下面显示的SEC开头的字符串
let DD_BOT_SECRET = 'SECaaa08485857b279d9774257d0fdd45d28fdb6828537fb64447dfaa90089c492c';
...
if (process.env.TG_USER_ID0) {
  TG_USER_ID0 = process.env.TG_USER_ID0;
}
if (process.env.TG_USER_ID1) {
  TG_USER_ID1 = process.env.TG_USER_ID1;
}
if (process.env.TG_USER_ID2) {
  TG_USER_ID2 = process.env.TG_USER_ID2;
}
if (process.env.TG_USER_ID3) {
  TG_USER_ID3 = process.env.TG_USER_ID3;
}
if (process.env.TG_USER_ID4) {
  TG_USER_ID4 = process.env.TG_USER_ID4;
}
if (process.env.TG_USER_ID5) {
  TG_USER_ID5 = process.env.TG_USER_ID5;
}
if (process.env.TG_USER_ID6) {
  TG_USER_ID6 = process.env.TG_USER_ID6;
}
if (process.env.TG_USER_ID7) {
  TG_USER_ID7 = process.env.TG_USER_ID7;
}
if (process.env.TG_USER_ID8) {
  TG_USER_ID8 = process.env.TG_USER_ID8;
}
if (process.env.TG_USER_ID9) {
  TG_USER_ID9 = process.env.TG_USER_ID9;
}
