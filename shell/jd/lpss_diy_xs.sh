...
wget -q --no-check-certificate https://raw.githubusercontent.com/lxrcbw/longzhuzhu/master/qx/jd_half_redrain.js -O /jd/scripts/jd_half_redrain.js
...
echo -e "自动更新lpss_diy_xs中~\n"
wget -q --no-check-certificate https://raw.githubusercontent.com/forpw2009/my_scripts/main/shell/jd/lpss_diy_xs.sh -O /jd/config/lpss_diy_xs.sh && chmod +x /jd/config/lpss_diy_xs.sh
echo -e "lpss_diy_xs脚本自动更新完成,感谢使用---下次同步时间为10min后"
